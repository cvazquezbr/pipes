...
import {
  exportPisCofinsIssExcel,
  processPisCofinsIssData,
...
export default function Home() {
  ...
  const [processingYear, setProcessingYear] = useState<string>(
  ...
  const handlePDFsProcessed = useCallback(
    async (results: ExtractedInvoice[]) => {
      console.log(
        "[Home] handlePDFsProcessed chamado com " +
          results.length +
          " resultado(s)"
      );
      const successCount = results.filter(
        r => !r.extractionErrors?.length
      ).length;
      console.log(
        "[Home] " +
          successCount +
      ...
      toast.success(
        `${successCount}/${results.length} notas fiscais processadas com sucesso`
      );
    },
    []
  );
    ...
    (format: "csv" | "json" | "xlsx" | "zoho-excel") => {
      try {
        if (format === "csv") {
          ...
          downloadFile(
            csv,
            `notas-fiscais-${new Date().toISOString().split("T")[0]}.csv`,
            "text/csv"
          );
          ...
          downloadFile(
            json,
            `notas-fiscais-${new Date().toISOString().split("T")[0]}.json`,
            "application/json"
          );
          ...
          toast.success(
            `ZOHO: ${report.validInvoices}/${report.totalInvoices} válidas`
          );
        }
      } catch (err) {
        const errorMessage =
  ...
  if (currentStep === 4) {
    if (workflow === "piscofinsiss") {
      processedData = processPisCofinsIssData(
        invoiceSheetData,
        billSheetData,
        allSheets
      ).faturasFinais;
  ...
  const taxTotals = (processedData as any[]).reduce(
    (acc, f) => ({
      ...
      <main className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center space-y-2">
              ...
              <p className="text-slate-500">
                Selecione uma das opções abaixo para começar o processamento.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    Processar dados de trabalhadores (JSON) e gerar informe de
                    rendimentos.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li className="flex items-center gap-2">
                      <Check className="h-3 w-3 text-green-500" /> Carga de JSON
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-3 w-3 text-green-500" /> Agregação de
                      códigos
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-3 w-3 text-green-500" /> Exportação
                      para Excel
                    </li>
                  </ul>
                </CardContent>
              ...
              >
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    Processar notas fiscais em PDF e exportar para o formato de
                    carga do ZOHO.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li className="flex items-center gap-2">
                      <Check className="h-3 w-3 text-green-500" /> Planilha de
                      referência
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-3 w-3 text-green-500" /> Upload de
                      PDFs NFS-e
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-3 w-3 text-green-500" /> Geração de
                      planilha ZOHO
                    </li>
                  </ul>
                </CardContent>
              ...
              >
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    Gerar relatório de impostos a partir de planilhas de
              ...
              >
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    Gerar relatório de IRPJ e CSLL com base em faturamento e
                ...
                <CardContent>
                  <ul className="space-y-2 text-sm text-slate-600">
                    ...
                    <li className="flex items-center gap-2">
                      <Check className="h-3 w-3 text-green-500" /> Valores de
                      aplicação
                    </li>
                  </ul>
                </CardContent>
        ...
        {workflow && (
          <nav aria-label="Progress" className="mb-12">
            <ol
              role="list"
              className="flex items-center justify-center space-x-4 md:space-x-12"
            >
        ...
        {workflow && (
          <div className="space-y-8">
                  ...
                  <div className="max-w-md mx-auto space-y-8 py-8">
                    <div className="text-center space-y-2">
                      <h3 className="text-xl font-bold">
                        Processamento de Rendimentos
                      </h3>
                      <p className="text-sm text-slate-500">
                        Informe o ano de referência para o processamento.
                      </p>
                    </div>
                ...
                {workflow === "rendimentos" ? (
                  ...
                  <div className="max-w-2xl mx-auto space-y-6">
                    <ExcelUpload
                      ...
                      rowFilter={row => {
                        ...
                        return String(row[billNumberKey] || "")
                          .toUpperCase()
                          .includes(" ISS");
                      }}
                    />
                  ...
                  <div className="max-w-md mx-auto space-y-8 py-8">
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-sm text-slate-500">
                        Informe os valores para compor a base de cálculo do
                        trimestre.
                      </p>
                    </div>
            ...
            {currentStep === 4 &&
              (workflow === "piscofinsiss" || workflow === "irpjcsll") && (
                      ...
                      <Button
                        onClick={() =>
                          exportIrpjCsllExcel(
                            invoiceSheetData,
                            allSheets,
                            parseFloat(resultadoAplicacao.replace(",", ".")) ||
                              0,
                            parseFloat(retencaoAplicacao.replace(",", ".")) || 0
                          )
                        }
                          ...
                          <table className="w-full text-sm">
                            ...
                            <tbody className="divide-y">
                              <tr className="bg-slate-50/50">
                                ...
                                <td
                                  className="text-right py-2 text-xs font-bold"
                                  colSpan={4}
                                >
                                  {taxTotals.totalFaturado.toLocaleString(
                                    "pt-BR",
                              ...
                              <tr>
                                ...
                                <td className="text-right py-2 text-xs">
                                  {taxTotals.cofinsDevido.toLocaleString(
                                    "pt-BR",
                                    { minimumFractionDigits: 2 }
                                  )}
                                </td>
                                <td className="text-right py-2 text-xs">
                                  {taxTotals.cofinsRetido.toLocaleString(
                                    "pt-BR",
                                    { minimumFractionDigits: 2 }
                                  )}
                                </td>
                                <td className="text-right py-2 text-xs text-slate-300">
                                  -
                                </td>
                                <td className="text-right py-2 text-xs font-semibold">
                                  {taxTotals.cofinsPendente.toLocaleString(
                                    "pt-BR",
                                    { minimumFractionDigits: 2 }
                                  )}
                                </td>
                              ...
                              <tr>
                                ...
                                <td className="text-right py-2 text-xs">
                                  {taxTotals.pisDevido.toLocaleString("pt-BR", {
                                    minimumFractionDigits: 2,
                                  })}
                                </td>
                                <td className="text-right py-2 text-xs">
                                  {taxTotals.pisRetido.toLocaleString("pt-BR", {
                                    minimumFractionDigits: 2,
                                  })}
                                </td>
                                <td className="text-right py-2 text-xs text-slate-300">
                                ...
                                <td className="text-right py-2 text-xs font-semibold">
                                  {taxTotals.pisPendente.toLocaleString(
                                    "pt-BR",
                                    { minimumFractionDigits: 2 }
                                  )}
                                </td>
                              ...
                              <tr>
                                ...
                                <td className="text-right py-2 text-xs">
                                  {taxTotals.issDevido.toLocaleString("pt-BR", {
                                    minimumFractionDigits: 2,
                                  })}
                                </td>
                                <td className="text-right py-2 text-xs">
                                  {taxTotals.issRetido.toLocaleString("pt-BR", {
                                    minimumFractionDigits: 2,
                                  })}
                                </td>
                                <td className="text-right py-2 text-xs">
                                  {taxTotals.issAntecipado.toLocaleString(
                                    "pt-BR",
                                    { minimumFractionDigits: 2 }
                                  )}
                                </td>
                                <td className="text-right py-2 text-xs font-semibold">
                                  {taxTotals.issPendente.toLocaleString(
                                    "pt-BR",
                                    { minimumFractionDigits: 2 }
                                  )}
                                </td>
                            ...
                            <tfoot>
                              <tr className="border-t-2 font-bold bg-slate-100/50">
                                ...
                                <td className="text-right py-2 text-xs text-primary">
                                  {(
                                    taxTotals.cofinsPendente +
                                    taxTotals.pisPendente +
                                    taxTotals.issPendente
                                  ).toLocaleString("pt-BR", {
                                    minimumFractionDigits: 2,
                                  })}
                                </td>
                              ...
                              <div className="space-y-1 text-sm">
                                <div className="flex justify-between">
                                  ...
                                  <span className="font-mono">
                                    R${" "}
                                    {irpjCsllResumo.totalFaturado.toLocaleString(
                                      "pt-BR",
                                      { minimumFractionDigits: 2 }
                                    )}
                                  </span>
                              ...
                              <div className="bg-primary/5 p-3 rounded-lg space-y-1 text-xs">
                                <div className="flex justify-between">
                                  ...
                                  <span className="font-bold">
                                    R${" "}
                                    {irpjCsllResumo.resultadoAplicacao.toLocaleString(
                                      "pt-BR",
                                      { minimumFractionDigits: 2 }
                                    )}
                                  </span>
                                ...
                                <div className="flex justify-between text-blue-600">
                                  ...
                                  <span className="font-bold">
                                    R${" "}
                                    {irpjCsllResumo.retencaoAplicacao.toLocaleString(
                                      "pt-BR",
                                      { minimumFractionDigits: 2 }
                                    )}
                                  </span>
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="space-y-1 text-sm">
                                  <div className="flex justify-between">
                                    ...
                                    <span className="font-mono">
                                      R${" "}
                                      {irpjCsllResumo.irDevido.toLocaleString(
                                        "pt-BR",
                                        { minimumFractionDigits: 2 }
                                      )}
                                    </span>
                                  ...
                                  <div className="flex justify-between">
                                    ...
                                    <span className="font-mono">
                                      R${" "}
                                      {irpjCsllResumo.irAdicional.toLocaleString(
                                        "pt-BR",
                                        { minimumFractionDigits: 2 }
                                      )}
                                    </span>
                                  ...
                                  <div className="flex justify-between text-blue-600">
                                    ...
                                    <span className="font-mono">
                                      R${" "}
                                      {irpjCsllResumo.irRetidoTotal.toLocaleString(
                                        "pt-BR",
                                        { minimumFractionDigits: 2 }
                                      )}
                                    </span>
                                  ...
                                  <div className="flex justify-between font-bold text-primary border-t pt-1">
                                    ...
                                    <span className="font-mono">
                                      R${" "}
                                      {irpjCsllResumo.totalIrpjDevido.toLocaleString(
                                        "pt-BR",
                                        { minimumFractionDigits: 2 }
                                      )}
                                    </span>
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="space-y-1 text-sm">
                                  <div className="flex justify-between">
                                    ...
                                    <span className="font-mono">
                                      R${" "}
                                      {irpjCsllResumo.csllDevidoTotal.toLocaleString(
                                        "pt-BR",
                                        { minimumFractionDigits: 2 }
                                      )}
                                    </span>
                                  ...
                                  <div className="flex justify-between text-blue-600">
                                    ...
                                    <span className="font-mono">
                                      R${" "}
                                      {irpjCsllResumo.csllRetidoTotal.toLocaleString(
                                        "pt-BR",
                                        { minimumFractionDigits: 2 }
                                      )}
                                    </span>
                                  ...
                                  <div className="flex justify-between font-bold text-primary border-t pt-1">
                                    ...
                                    <span className="font-mono">
                                      R${" "}
                                      {irpjCsllResumo.totalCsllDevido.toLocaleString(
                                        "pt-BR",
                                        { minimumFractionDigits: 2 }
                                      )}
                                    </span>
                  ...
                  <div className="grid grid-cols-1 gap-8">
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-sm font-medium">
                          Faturas Processadas ({processedData.length})
                        </CardTitle>
                      </CardHeader>
                      <CardContent>
                          ...
                          <table className="w-full">
                            <thead className="bg-muted sticky top-0 z-10">
                              <tr>
                                ...
                                <th className="p-1 text-right text-blue-600">
                                  IRPJ Ret.
                                </th>
                                <th className="p-1 text-right text-blue-600">
                                  CSLL Ret.
                              ...
                              {processedData.map((f, i) => (
                                ...
                                >
                                  ...
                                  <td className="p-1 whitespace-nowrap">
                                    {String(f.InvoiceDateFormatted || "")}
                                  </td>
                                  <td
                                    className="p-1 truncate max-w-[120px]"
                                    title={String(f.CustomerName || "")}
                                  >
                                    {String(f.CustomerName || "")}
                                  </td>
                                  <td
                                    className="p-1 truncate max-w-[150px]"
                                    title={String(f.ItemTaxScheme || "")}
                                  >
                                    <span
                                      className={
                                        f.ItemTaxScheme === "Não encontrado"
                                  ...
                                  <td className="p-1 text-right font-medium">
                                    {(f.Total || 0).toLocaleString("pt-BR", {
                                      minimumFractionDigits: 2,
                                    })}
                                  </td>
                                  <td className="p-1 text-right text-blue-600">
                                    {(f["IRPJ.retido"] || 0).toLocaleString(
                                      "pt-BR",
                                      { minimumFractionDigits: 2 }
                                    )}
                                  </td>
                                  <td className="p-1 text-right text-blue-600">
                                    {(f["CSLL.retido"] || 0).toLocaleString(
                                      "pt-BR",
                                      { minimumFractionDigits: 2 }
                                    )}
                                  </td>
                                  {workflow === "piscofinsiss" && (
                                    <>
                                      ...
                                      <td className="p-1 text-right text-blue-600">
                                        {(f["PIS.retido"] || 0).toLocaleString(
                                          "pt-BR",
                                          { minimumFractionDigits: 2 }
                                        )}
                                      </td>
                                      <td className="p-1 text-right text-blue-600">
                                        {(f["ISS.retido"] || 0).toLocaleString(
                                          "pt-BR",
                                          { minimumFractionDigits: 2 }
                                        )}
                                      </td>
                                  ...
                                  {workflow === "irpjcsll" && (
                                    <>
                                      <td className="p-1 text-right text-primary">
                                        {(
                                          f["contribuicao.IRPJ"] || 0
                                        ).toLocaleString("pt-BR", {
                                          minimumFractionDigits: 2,
                                        })}
                                      </td>
                    ...
                    {workflow === "piscofinsiss" && (
                      <Card>
                        <CardHeader>
                          <CardTitle className="text-sm font-medium">
                            Cobranças ISS Importadas ({billSheetData.length})
                          </CardTitle>
                        </CardHeader>
                        <CardContent>
                              ...
                              <tbody>
                                {billSheetData.slice(0, 50).map((row, i) => (
                                  <tr key={i} className="border-t">
                                    <td className="p-1">
                                      {String(row["Bill Number"] || "")}
                                    </td>
                                    <td className="p-1">
                                      {String(row["Bill Date"] || "")}
                                    </td>
                                ...
                                {billSheetData.length > 50 && (
                                  <tr>
                                    ...
                                    >
                                      E mais {billSheetData.length - 50}{" "}
                                      registros...
                                    </td>
                                  </tr>
                                )}
      ...
      <footer className="border-t border-slate-200 bg-white mt-12">
        <div className="container mx-auto px-4 py-6">
          <p className="text-xs text-slate-600 text-center">
            Processador de Notas Fiscais • Extração automática de dados de PDFs
            DANFSe
          </p>
        </div>
      </footer>
